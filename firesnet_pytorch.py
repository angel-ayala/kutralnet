...
from models.firesnet import oct_firesnet
...
# img_dims = (68, 68)
img_dims = (64, 64)
model_name = 'model_firesnet.pth'

#### Training
if must_train:
    # dataset read and preprocess
    ...
    # model parameters
    net = oct_firesnet(num_classes=num_classes)
    print(net)
...
if must_test:
    ...
    transform_compose = transforms.Compose([
               ...
               transforms.ToTensor(),
               # transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)) # values [-1, 1]
               # transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225)) # values ~[-1, 1]
               CustomNormalize((-1, 1))
            ])
